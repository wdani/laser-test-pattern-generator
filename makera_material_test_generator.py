...
def nc_header(settings: GeneratorSettings) -> List[str]:
    s_max_text = fmt_s_value(settings.nc_s_max, settings.nc_s_max)
    return [
        f"; Generated by Makera Material Test Generator {APP_VERSION}",
        ...
        f"; S max = {settings.nc_s_max:g}; 100% power maps to S{s_max_text}",
        "G21 ; millimeters",
